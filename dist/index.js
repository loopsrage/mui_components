...
import ue from "@mui/icons-material/BugReport";
import de from "@mui/icons-material/Home";
import fe from "@mui/icons-material/Settings";
//#region \0rolldown/runtime.js
var W = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), G = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), K = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), pe = t(null), q = () => r(pe), me = (e, t = !0) => {
	let n = q();
	return (r) => {
...
var Be = ({ endpoint: e, handleErr: t }) => {
	...
	if (r === "object") {
		...
		if (i.defaultValue.Subtype === 19) return /* @__PURE__ */ k(Ot, { data: Se(Y(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 17) return /* @__PURE__ */ k(Le, { data: Se(Y(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 16 || i.defaultValue.Subtype === 0) {
			let r = Se(Y(e), n.slice(0, n.lastIndexOf(".")));
...
}, Y = (e) => e.current.container, Xe = (e, t) => {
	...
	return { onChange: (n) => {
		...
		J(Se(Y(e), c)) && (c = s.slice(0, s.length - 2).join(".")), n.target.type === "checkbox" && (r = n.currentTarget.checked), e.current = t, Ye(e, Ee(Y(e), c, l, r)), e.current = t;
	} };
}, $e = (e, t) => {
	...
	we(t, (t) => {
		...
		Object.keys(r).forEach((t) => {
			J(r[t]) || (typeof r[t] == "object" && Object.keys(r[t]).forEach((i) => {
				let a = {};
				a[i] = r[t][i], tt(e, n + "." + t + "." + i, a);
			}), ge(r[t]) && tt(e, n + "." + t, r[t]));
		});
	});
}, rt = ({ title: e, button_title: t, getButton: n, tabs: r, getSchema: i, handleSave: o, elementSelector: l, footerButtons: f, refKey: p, register_component: m = !1, context: h = null }) => {
	...
	let [S, C] = c(void 0), [w, E] = c(0), O = async () => {
		try {
			Ye(_, De(null, [], ".", await i())), Je(_, b), nt({
				formRef: _,
				container: Y(_)
			}), C(Ze(_)), y(!0);
		} catch (e) {
	...
	return f ||= [
		/* @__PURE__ */ k(d, {
			onClick: () => {
				...
				e[_.current.index] = "";
				let t = Y(_);
				J(Se(t, "root.fields")) && Ye(_, xe(t, "root.fields", {})), tt(_, "root.fields." + _.current.index, e), C(Ze(_));
			},
			children: "Add Field"
		}),
		/* @__PURE__ */ k(d, {
		...
		children: [n ? n(O) : /* @__PURE__ */ k(d, {
			...
			body: /* @__PURE__ */ A(u, {
				...
				children: [
					...
					w === 1 && /* @__PURE__ */ k(u, {
						sx: { p: 3 },
						children: /* @__PURE__ */ k("pre", { children: JSON.stringify(Y(_)?.value, null, 2) })
					})
				]
			}),
			show: v,
...
}, it = ({ title: e, show: t, onCancel: n, onConfirm: r }) => /* @__PURE__ */ k(he, {
...
}), at = ({ refreshGrid: e, api: t, id: n, title: r, footerButtons: i, ...a }) => /* @__PURE__ */ k(rt, {
	title: r,
	button_title: "Update",
	getSchema: Ve(t, n),
	handleSave: (r) => {
...
}, st = ({ handleRefreshGrid: e, api: t, id: n, params: r }) => {
	let i = {
		...r,
		refreshGrid: e,
		api: t,
	...
	return /* @__PURE__ */ A(T, {
		...
		children: [/* @__PURE__ */ k(at, { ...i }), /* @__PURE__ */ k(ot, { ...i })]
	});
}, ct = (e, t) => {
	let n = e.current;
	Te(t, (e) => {
...
}, yt = (e) => e.current.fetch_params, bt = (e, t) => ({ getRows: async (n) => {
	let r = e.current;
	if (!r) return {
		rows: [],
		rowCount: 0
	};
	vt(e, n.filterModel), _t(e, n.sortModel);
	...
	return ct(e, l), dt(e, l), r.row_count = c.pagination?.total || 0, e.current = r, t(), {
		rows: pt(e),
		rowCount: c.pagination?.total || 0
	};
} }), xt = (e) => e.current?.datasource, St = async (e) => {
	let t = e.current;
	if (!t) return;
	...
	return (n) => {
		...
		return /* @__PURE__ */ k(st, {
			...
			handleRefreshGrid: async () => await St(e),
			api: r.api,
			id: n.id
		});
	};
}, Et = ({ api: e, endpoint: t, row_details: n, refKey: r, cellRenderer: i, register_component: o = !1, toolbar: l = !1, checkbox_select: u = !1, datagrid_sx: d = void 0, grid_options: f = void 0, context: p = void 0 }) => {
	...
	return h.current ||= {
		...
		onRowSelectionModelChange: (e) => Ct(h)(e),
...
var Dt = () => {
...
}, kt = t(null), At = () => r(kt), jt = (e, t = !0) => {
	let n = At();
	return (r) => {
		t && r ? n?.register(e, r) : n?.unregister(e);
	};
}, Mt = ({ title: e, body: t, show: n, footer: r, title_sx: i, footer_sx: a, content_sx: o, paper_sx: s }) => /* @__PURE__ */ A(h, {
	open: n,
	maxWidth: "lg",
	fullWidth: !0,
	scroll: "paper",
	...
	let t = typeof e;
	return t === "string" || t === "number" || t === "boolean" || t === "undefined" || t === "symbol" || t === "bigint" || t === "int";
}, X = (e) => e == null, Pt = (e, t) => X(e) ? "" : e.split(t).map((e) => e.charAt(0).toUpperCase() + e.slice(1)).join(" "), Ft = "Values", It = "Containers", Lt = (e, t, n, r) => {
	let i = r || {
		[Ft]: /* @__PURE__ */ new Map(),
		[It]: /* @__PURE__ */ new Map()
	}, a = e ? t : "root", o = {
	...
	return e || (o.root = o), i[Ft].set(a, n), i[It].set(a, o), Object.freeze(o);
}, Rt = (e, t, n) => {
...
}, zt = (e, t) => e.containerIndex[It].get(t), Bt = (e, t) => {
	for (let [n, r] of e.containerIndex[Ft].entries()) t(n, r);
}, Vt = (e, t) => {
	for (let [, n] of e.containerIndex[It].entries()) t(n);
}, Ht = (e, t, n = 2) => {
	Bt(e, (e, r) => {
		let i = Object.keys(r);
		for (let a = 0; a < i.length; a++) {
	...
	if (!e || !t) return e;
	let i = e.containerIndex[It].get(t);
	if (!i) return console.warn(`Container at path "${t}" not found.`), e;
	let a = {};
	a[n] = r;
	let o = {
	...
	e.containerIndex[It].set(t, s), e.containerIndex[Ft].set(t, o);
	let c = s;
	for (; c.parent;) {
		let t = c.parent, n = t.children.map((e) => e.path === c.path ? c : e), r = c.path.split("."), i = r.slice(r.length - 1), a = { ...e.containerIndex[Ft].get(t.path) };
		a[i] = o;
		let s = Object.freeze({
			...t,
			children: n,
		...
		e.containerIndex[It].set(s.path, s), c = s;
	}
	return e.containerIndex[It].get("root");
}, Wt = (e = null, t = [], n = "_", ...r) => {
	...
	let i = (e, t) => {
		...
		return typeof r == "object" && r && (Array.isArray(r) ? r.forEach((r, a) => {
			if (typeof r == "object" && r) {
				let o = [...t, String(a)];
				i(Rt(e, o.join(n), r).children.at(-1), o);
			}
		}) : Object.entries(r).forEach(([r, a]) => {
			if (typeof a == "object" && a) {
				let o = [...t, r];
				i(Rt(e, o.join(n), a).children.at(-1), o);
			}
		})), e;
	};
	return i(e, t);
}, Gt = ({ inputKey: t, inputProps: n }) => {
	let r = Object.keys(n.defaultValue)[0], a = n.defaultValue[r], [o, s] = c(/* @__PURE__ */ k(b, {
		type: "text",
		onChange: n.onChange,
		defaultValue: a
...
}, Kt = ({ fileData: e, onChange: t, name: n }) => {
	let [r] = L(), a = s("");
	return i(() => {
		e && (async () => {
			if (!e) return;
	...
	for (let t = 0; t < e.length; t++) n[t] = e.charCodeAt(t);
	return n;
}, $t = "data:image/#{encoding};base64,#{data}", en = ({ data: e, encoding: t, alt: n }) => {
	let r = $t, [i, a] = c(void 0);
	return X(t) && (t = "png"), X(n) && (n = "ERROR"), Zt(new Blob([Qt(e)])).then((e) => {
		r = r.replace("#{encoding}", t), r = r.replace("#{data}", Xt.Buffer.from(e).toString("base64")), a(r);
	}), /* @__PURE__ */ k(Box, {
		component: "img",
		src: i,
		alt: n,
	...
	return t;
}, nn = (e, { baseHeaders: t, handleErr: n, handleFinally: r, debug: i } = {}) => {
	let a = {
		"Content-Type": "application/json",
		...t
	}, o = (e) => {
		...
		return X(l) || (f.method === "POST" && (f.body = JSON.stringify(l)), f.method === "GET" && (u += tn(l))), fetch(u, f).catch((e) => n(e)).finally(() => {
			i && o({
				endpoint: t,
				inputHeaders: s,
				fetchParams: c
...
nn("http://localhost:8080/", {
	handleErr: (e) => console.log(e),
	debug: !0
});
var rn = ({ endpoint: e, handleErr: t }) => {
	X(t) && (t = (e) => console.log(e));
	let n = nn(e, { handleErr: t });
	return {
		at: async (e, t) => await n.fetchJson({
			endpoint: e,
			...t
...
}, an = (e, t) => () => e.get(t), on = ({ jsxKey: e, endpoint: t, inputProps: n }) => {
	let [r, a] = c([/* @__PURE__ */ k("option", {
		value: n.defaultValue,
		children: n.defaultValue
	}, e + "-" + n.defaultValue)]), o = rn({ endpoint: t });
	return i(() => {
		o.selectOptions().then((t) => {
			a(Object.keys(t).map((n) => {
				let r = t[n][Object.keys(t[n])[1]], i = t[n][Object.keys(t[n])[0]];
...
}, sn = ({ buttons: e, endpoint: t, title: n, title_topology_params: r, button_stack_params: i, header_stack_params: a, outer_stack_params: o, ...s }) => {
	let c = e?.map((e) => e);
	return /* @__PURE__ */ A(T, {
		direction: "column",
		spacing: 1,
...
}, cn = ({ api: e, endpoint: t, refKey: n, register_component: r, ...a }) => {
	let o = At();
	return i(() => {
		(async () => {
			let e = o?.get(n);
...
}, ln = ({ jsxKey: e, key: t, inputProps: n }) => {
	let r;
	return t.charAt(t.length - 1) === "D" && t.charAt(t.length - 2) === "I" || t.charAt(t.length - 1) === "S" && t.charAt(t.length - 2) === "D" ? (t.charAt(t.length - 1) === "D" && t.charAt(t.length - 2) === "I" && (r = t.slice(5, t.length - 2)), t.charAt(t.length - 1) === "S" && t.charAt(t.length - 2) === "D" && (r = t.slice(5, t.length - 3), n = {
		...n,
		multiple: !0
...
}, un = () => ({ formRef: e, jsxKey: t, key: n, currentType: r, inputProps: i }) => {
	let a = ln({
		jsxKey: t,
		key: n,
		inputProps: i
	...
	if (r === "object") {
		if (i.defaultValue.Subtype === 20) return /* @__PURE__ */ k(cn, {
			api: e.current?.api,
			refKey: "csv_grid",
			register_component: !0
		}, t);
		if (i.defaultValue.Subtype === 19) return /* @__PURE__ */ k(qn, { data: zt(Z(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 17) return /* @__PURE__ */ k(en, { data: zt(Z(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 16 || i.defaultValue.Subtype === 0) {
			let r = zt(Z(e), n.slice(0, n.lastIndexOf(".")));
...
}, Z = (e) => e.current.container, mn = (e, t) => {
	let n = e.current, r = n.labels[t], i = n.element_component[t];
	return n.useLabels[t] ? /* @__PURE__ */ A(T, {
		direction: "column",
		spacing: 1,
	...
	return { onChange: (n) => {
		...
		let s = a.split("."), c = s.slice(0, s.length - 1).join("."), l = s.slice(s.length - 1);
		X(zt(Z(e), c)) && (c = s.slice(0, s.length - 2).join(".")), n.target.type === "checkbox" && (r = n.currentTarget.checked), e.current = t, pn(e, Ut(Z(e), c, l, r)), e.current = t;
	} };
}, _n = (e, t) => {
	let n = e.current, r = n.nameIndex[t];
	return n.elements[r];
	...
	let r = e.current, i = Pt(t.replace(/root\./, ""), "_"), a = i.split(".");
	if (!a.some((e) => e.toLowerCase() === "data")) {
		if (X(r.nameIndex[t])) {
			r.nameIndex[t] = r.index, r.elements[r.index] = n;
			let o = vn(e, t, n);
	...
	Vt(t, (t) => {
		...
		Object.keys(r).forEach((t) => {
			X(r[t]) || (typeof r[t] == "object" && Object.keys(r[t]).forEach((i) => {
				let a = {};
				a[i] = r[t][i], yn(e, n + "." + t + "." + i, a);
			}), Nt(r[t]) && yn(e, n + "." + t, r[t]));
		});
	});
}, xn = ({ title: e, button_title: t, getButton: n, tabs: r, getSchema: i, handleSave: o, elementSelector: l, footerButtons: f, refKey: p, register_component: m = !1, context: h = null }) => {
	let g = jt(p, m), _ = s(null), [v, y] = c(!1), b = () => {
		y(!1);
	}, x = () => {
		o(Z(_).value), y(!1);
	};
	...
	let [S, C] = c(void 0), [w, E] = c(0), O = async () => {
		try {
			pn(_, Wt(null, [], ".", await i())), fn(_, b), bn({
				formRef: _,
				container: Z(_)
			}), C(hn(_)), y(!0);
		} catch (e) {
	...
	return f ||= [
		/* @__PURE__ */ k(d, {
			onClick: () => {
				...
				e[_.current.index] = "";
				let t = Z(_);
				X(zt(t, "root.fields")) && pn(_, Rt(t, "root.fields", {})), yn(_, "root.fields." + _.current.index, e), C(hn(_));
			},
			children: "Add Field"
		}),
		/* @__PURE__ */ k(d, {
...
}, Sn = ({ title: e, show: t, onCancel: n, onConfirm: r }) => /* @__PURE__ */ k(Mt, {
	title: e || "Are you sure?",
	show: t,
	footer: /* @__PURE__ */ A(T, {
		direction: "column",
...
}), Cn = ({ refreshGrid: e, api: t, id: n, title: r, footerButtons: i, ...a }) => /* @__PURE__ */ k(xn, {
	title: r,
	button_title: "Update",
	getSchema: an(t, n),
	handleSave: (r) => {
...
}, Tn = ({ handleRefreshGrid: e, api: t, id: n, params: r }) => {
	let i = {
		...r,
		refreshGrid: e,
		api: t,
	...
	return /* @__PURE__ */ A(T, {
		...
		children: [/* @__PURE__ */ k(Cn, { ...i }), /* @__PURE__ */ k(wn, { ...i })]
	});
}, En = (e, t) => {
	let n = e.current;
	Ht(t, (e) => {
	...
	let r = n.headers_ri.Field, i = n.headers_ri.Value;
	Object.entries(t).forEach(([e, t]) => {
		if (r !== void 0 && n.rows[r].push(Pt(e, "_")), i !== void 0) {
			let e = Array.isArray(t) ? t.join(", ") : t;
			n.rows[i].push(e);
		}
		n.row_count++;
	...
	let n = e.current;
	n && (n.args.filterModel = JSON.stringify(t), e.current = n);
}, Ln = (e) => e.current.fetch_params, Rn = (e, t) => ({ getRows: async (n) => {
	let r = e.current;
	if (!r) return {
		rows: [],
		rowCount: 0
	};
	In(e, n.filterModel), Fn(e, n.sortModel);
	let { page: i, pageSize: a } = n.paginationModel ?? {
		page: 0,
		pageSize: 10
	}, o = {
	...
	return En(e, l), kn(e, l), r.row_count = c.pagination?.total || 0, e.current = r, t(), {
		rows: jn(e),
		rowCount: c.pagination?.total || 0
	};
} }), zn = (e, t) => {
...
}, Bn = (e) => e.current?.datasource, Vn = async (e) => {
	let t = e.current;
	if (!t) return;
	let n = t.gridRef.current;
	n.dataSource.cache.clear(), await n.dataSource.fetchRows(), t.refresh();
	...
	let t = e.current;
	if (t) return t.cellRenderer ? t.cellRenderer(e) : Wn(e);
}, Wn = (e) => {
	let t = At();
	return (n) => {
		let r = e.current;
		...
		return /* @__PURE__ */ k(Tn, {
			...
			handleRefreshGrid: async () => await Vn(e),
			api: r.api,
			id: n.id
		});
	};
}, Gn = ({ api: e, endpoint: t, row_details: n, refKey: r, cellRenderer: i, register_component: o = !1, toolbar: l = !1, checkbox_select: u = !1, datagrid_sx: d = void 0, grid_options: f = void 0, context: p = void 0 }) => {
	let m = jt(r, o), h = s(null), [, g] = c(!1), [_, v] = c({
		page: 0,
		pageSize: 25
	}), [y, b] = c(0), [x, S] = c({ id: !1 }), C = N(), w = () => {
		h.current && b(h.current?.row_count ?? 0), g((e) => !e);
	...
	return h.current ||= {
		...
		onRowSelectionModelChange: (e) => Hn(h)(e),
		paginationMode: "server",
		sortingMode: "server",
		filterMode: "server",
		autosizeOnMount: !0,
...
var Kn = () => {
	...
	let t = At(), n = jt("app_ctrl", !0), [r, o] = c(e), l = s({
		active: e,
		setActive: (e) => {
			o(e);
		}
	...
	return i(() => {
		(t?.get("appbar")).register_element({
			...
			settings: /* @__PURE__ */ k(y, {
				...
				children: /* @__PURE__ */ k(fe, { fontSize: "small" })
			}),
			debug: /* @__PURE__ */ k(y, {
				size: "small",
				sx: { color: "white" },
...
}, $n = ({ title: e, appbar_sx: t, refKey: n, register_component: r }) => {
	let [i, o] = c({}), d = Qn(n, r), f = s({ register_element: (e) => {
		o({
			...i,
			...e
		});
...
}), tr = ({ api: e, endpoint: t, children: n, get_args: r, fetch_params: i, callback: a, ...o }) => /* @__PURE__ */ k(d, {
	onClick: async () => {
		try {
			let n = {};
			r && (n = r());
	...
	...o,
	children: n
}), nr = ({ children: e, sx: t = {} }) => /* @__PURE__ */ k(u, {
	sx: {
		display: "flex",
		flexDirection: "column",
		justifyContent: "center",
...
}), rr = ({ title: e, body: t, show: n, footer: r, title_sx: i, footer_sx: a, content_sx: o, paper_sx: s }) => /* @__PURE__ */ A(h, {
	open: n,
	maxWidth: "lg",
	fullWidth: !0,
	scroll: "paper",
	...
	let t = typeof e;
	return t === "string" || t === "number" || t === "boolean" || t === "undefined" || t === "symbol" || t === "bigint" || t === "int";
}, Q = (e) => e == null, ar = (e, t) => Q(e) ? "" : e.split(t).map((e) => e.charAt(0).toUpperCase() + e.slice(1)).join(" "), or = "Values", sr = "Containers", cr = (e, t, n, r) => {
	let i = r || {
		[or]: /* @__PURE__ */ new Map(),
		[sr]: /* @__PURE__ */ new Map()
	}, a = e ? t : "root", o = {
	...
	return e || (o.root = o), i[or].set(a, n), i[sr].set(a, o), Object.freeze(o);
}, lr = (e) => e.parent || null, ur = (e) => [...e.children], dr = (e) => e.value, fr = (e) => e.path, pr = (e, t, n) => {
	let r = cr(e, t, n, e.containerIndex);
	return {
		...e,
		children: [...e.children, r]
	};
...
}), hr = (e, t) => e.containerIndex[or].get(t), gr = (e, t) => e.containerIndex[sr].get(t), _r = (e, t) => {
	for (let [n, r] of e.containerIndex[or].entries()) t(n, r);
}, vr = (e, t) => {
	for (let [, n] of e.containerIndex[sr].entries()) t(n);
}, yr = (e, t, n = 2) => {
	_r(e, (e, r) => {
		let i = Object.keys(r);
		for (let a = 0; a < i.length; a++) {
	...
	if (!e || !t) return e;
	let i = e.containerIndex[sr].get(t);
	if (!i) return console.warn(`Container at path "${t}" not found.`), e;
	let a = {};
	a[n] = r;
	let o = {
		...i.value,
		...a
	}, s = cr(i.parent, i.path, o, e.containerIndex);
	e.containerIndex[sr].set(t, s), e.containerIndex[or].set(t, o);
	let c = s;
	for (; c.parent;) {
		let t = c.parent, n = t.children.map((e) => e.path === c.path ? c : e), r = c.path.split("."), i = r.slice(r.length - 1), a = { ...e.containerIndex[or].get(t.path) };
		a[i] = o;
		let s = Object.freeze({
			...t,
			children: n,
		...
		e.containerIndex[sr].set(s.path, s), c = s;
	}
	return e.containerIndex[sr].get("root");
}, xr = (e = null, t = [], n = "_", ...r) => {
	e === null && (e = cr(null, "root", r.length === 0 ? {} : r[0]), t = ["root"]);
	let i = (e, t) => {
		let r = e.value;
		return typeof r == "object" && r && (Array.isArray(r) ? r.forEach((r, a) => {
			if (typeof r == "object" && r) {
				let o = [...t, String(a)];
				i(pr(e, o.join(n), r).children.at(-1), o);
			}
		}) : Object.entries(r).forEach(([r, a]) => {
			if (typeof a == "object" && a) {
				let o = [...t, r];
				i(pr(e, o.join(n), a).children.at(-1), o);
			}
		})), e;
	};
	return i(e, t);
}, Sr = ({ inputKey: t, inputProps: n }) => {
	let r = Object.keys(n.defaultValue)[0], a = n.defaultValue[r], [o, s] = c(/* @__PURE__ */ k(b, {
		type: "text",
		onChange: n.onChange,
		defaultValue: a
...
}, Cr = ({ fileData: e, onChange: t, name: n }) => {
	let [r] = L(), a = s("");
	return i(() => {
		e && (async () => {
			if (!e) return;
...
}, wr = ({ fileData: e, subtype: t, inputProps: n }) => /* @__PURE__ */ k(u, {
	sx: { width: "100%" },
	children: /* @__PURE__ */ k(C, {
		variant: "outlined",
		sx: {
	...
	for (let t = 0; t < e.length; t++) n[t] = e.charCodeAt(t);
	return n;
}, Ar = "data:image/#{encoding};base64,#{data}", jr = ({ data: e, encoding: t, alt: n }) => {
	let r = Ar, [i, a] = c(void 0);
	return Q(t) && (t = "png"), Q(n) && (n = "ERROR"), Or(new Blob([kr(e)])).then((e) => {
		r = r.replace("#{encoding}", t), r = r.replace("#{data}", Dr.Buffer.from(e).toString("base64")), a(r);
	}), /* @__PURE__ */ k(Box, {
		component: "img",
		src: i,
		alt: n,
	...
	return t;
}, Nr = (e, { baseHeaders: t, handleErr: n, handleFinally: r, debug: i } = {}) => {
	let a = {
		"Content-Type": "application/json",
		...t
	}, o = (e) => {
		...
		return Q(l) || (f.method === "POST" && (f.body = JSON.stringify(l)), f.method === "GET" && (u += Mr(l))), fetch(u, f).catch((e) => n(e)).finally(() => {
			i && o({
				endpoint: t,
				inputHeaders: s,
				fetchParams: c
...
var Pr = ({ endpoint: e, handleErr: t }) => {
	Q(t) && (t = (e) => console.log(e));
	let n = Nr(e, { handleErr: t });
	return {
		at: async (e, t) => await n.fetchJson({
			endpoint: e,
			...t
...
}, Fr = (e, t) => () => e.get(t), Ir = ({ jsxKey: e, endpoint: t, inputProps: n }) => {
	let [r, a] = c([/* @__PURE__ */ k("option", {
		value: n.defaultValue,
		children: n.defaultValue
	}, e + "-" + n.defaultValue)]), o = Pr({ endpoint: t });
	return i(() => {
		o.selectOptions().then((t) => {
			a(Object.keys(t).map((n) => {
				let r = t[n][Object.keys(t[n])[1]], i = t[n][Object.keys(t[n])[0]];
...
}, Lr = ({ buttons: e, endpoint: t, title: n, title_topology_params: r, button_stack_params: i, header_stack_params: a, outer_stack_params: o, ...s }) => {
	let c = e?.map((e) => e);
	return /* @__PURE__ */ A(T, {
		direction: "column",
		spacing: 1,
...
}, zr = ({ api: e, endpoint: t, refKey: n, register_component: r, ...a }) => {
	let o = Xn();
	return i(() => {
		(async () => {
			let e = o?.get(n);
...
}, Br = ({ jsxKey: e, key: t, inputProps: n }) => {
	let r;
	return t.charAt(t.length - 1) === "D" && t.charAt(t.length - 2) === "I" || t.charAt(t.length - 1) === "S" && t.charAt(t.length - 2) === "D" ? (t.charAt(t.length - 1) === "D" && t.charAt(t.length - 2) === "I" && (r = t.slice(5, t.length - 2)), t.charAt(t.length - 1) === "S" && t.charAt(t.length - 2) === "D" && (r = t.slice(5, t.length - 3), n = {
		...n,
		multiple: !0
...
}, Vr = () => ({ formRef: e, jsxKey: t, key: n, currentType: r, inputProps: i }) => {
	let a = Br({
		jsxKey: t,
		key: n,
		inputProps: i
	...
	if (r === "object") {
		if (i.defaultValue.Subtype === 20) return /* @__PURE__ */ k(zr, {
			api: e.current?.api,
			refKey: "csv_grid",
			register_component: !0
		}, t);
		if (i.defaultValue.Subtype === 19) return /* @__PURE__ */ k(Yi, { data: gr($(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 17) return /* @__PURE__ */ k(jr, { data: gr($(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 16 || i.defaultValue.Subtype === 0) {
			let r = gr($(e), n.slice(0, n.lastIndexOf(".")));
			return i.name = n.slice(0, n.lastIndexOf(".")) + ".Data", /* @__PURE__ */ k(wr, {
				fileData: JSON.stringify(r?.value.Data, null, 2),
				inputProps: i,
				subtype: i.defaultValue.Subtype
			}, t);
	...
	return { onChange: (n) => {
		...
		let s = a.split("."), c = s.slice(0, s.length - 1).join("."), l = s.slice(s.length - 1);
		Q(gr($(e), c)) && (c = s.slice(0, s.length - 2).join(".")), n.target.type === "checkbox" && (r = n.currentTarget.checked), e.current = t, Gr(e, br($(e), c, l, r)), e.current = t;
	} };
}, Yr = (e, t) => {
	let n = e.current, r = n.nameIndex[t];
	return n.elements[r];
	...
	let r = e.current, i = ar(t.replace(/root\./, ""), "_"), a = i.split(".");
	if (!a.some((e) => e.toLowerCase() === "data")) {
		if (Q(r.nameIndex[t])) {
			r.nameIndex[t] = r.index, r.elements[r.index] = n;
			let o = Xr(e, t, n);
...
}, Qr = (e, t) => e.current.nameIndex[t], $r = (e, t) => {
	let n = e.current;
	delete n.labels[Qr(e, t)], e.current = n;
...
}, ti = ({ title: e, button_title: t, getButton: n, tabs: r, getSchema: i, handleSave: o, elementSelector: l, footerButtons: f, refKey: p, register_component: m = !1, context: h = null }) => {
	...
	let [S, C] = c(void 0), [w, E] = c(0), O = async () => {
		try {
			Gr(_, xr(null, [], ".", await i())), Wr(_, b), ei({
				formRef: _,
				container: $(_)
			}), C(qr(_)), y(!0);
		} catch (e) {
	...
	return f ||= [
		/* @__PURE__ */ k(d, {
			onClick: () => {
				...
				e[_.current.index] = "";
				let t = $(_);
				Q(gr(t, "root.fields")) && Gr(_, pr(t, "root.fields", {})), Zr(_, "root.fields." + _.current.index, e), C(qr(_));
			},
			children: "Add Field"
		}),
		/* @__PURE__ */ k(d, {
		...
		children: [n ? n(O) : /* @__PURE__ */ k(d, {
			...
			body: /* @__PURE__ */ A(u, {
				...
				children: [
					...
					w === 1 && /* @__PURE__ */ k(u, {
						sx: { p: 3 },
						children: /* @__PURE__ */ k("pre", { children: JSON.stringify($(_)?.value, null, 2) })
					})
				]
			}),
			show: v,
...
}, ni = ({ title: e, show: t, onCancel: n, onConfirm: r }) => /* @__PURE__ */ k(rr, {
	title: e || "Are you sure?",
	show: t,
	footer: /* @__PURE__ */ A(T, {
		direction: "column",
...
}), ri = ({ refreshGrid: e, api: t, ...n }) => /* @__PURE__ */ k(ti, {
	title: "Create",
	getSchema: t.schema,
	handleSave: (n) => {
		t.create(n).then(() => e());
	...
	...n
}), ii = ({ refreshGrid: e, api: t, id: n, title: r, footerButtons: i, ...a }) => /* @__PURE__ */ k(ti, {
	title: r,
	button_title: "Update",
	getSchema: Fr(t, n),
	handleSave: (r) => {
	...
	refKey: String(n),
	...a
}), ai = ({ refreshGrid: e, api: t, handleSelectedIds: n }) => {
	let [r, i] = c(!1);
	return /* @__PURE__ */ A(T, {
		direction: "horizontal",
		spacing: 2,
...
}, si = ({ handleRefreshGrid: e, api: t, id: n, params: r }) => {
	let i = {
		...r,
		refreshGrid: e,
		api: t,
	...
	return /* @__PURE__ */ A(T, {
		...
		children: [/* @__PURE__ */ k(ii, { ...i }), /* @__PURE__ */ k(oi, { ...i })]
	});
}, ci = (e, t) => {
	let n = e.current;
	n && (n.endpoint = t);
}, li = (e) => e.current.endpoint, ui = (e) => e.current.api, di = (e, t) => {
	...
	let r = n.headers_ri.Field, i = n.headers_ri.Value;
	Object.entries(t).forEach(([e, t]) => {
		if (r !== void 0 && n.rows[r].push(ar(e, "_")), i !== void 0) {
			let e = Array.isArray(t) ? t.join(", ") : t;
			n.rows[i].push(e);
		}
		n.row_count++;
	...
	return n;
}, bi = (e) => e.current.paginationModel, xi = (e, t) => {
	let n = e.current;
...
}, Di = (e) => e.current.fetch_params, Oi = (e, t) => ({ getRows: async (n) => {
	let r = e.current;
	if (!r) return {
		rows: [],
		rowCount: 0
	};
	wi(e, n.filterModel), Ci(e, n.sortModel);
	let { page: i, pageSize: a } = n.paginationModel ?? {
		page: 0,
		pageSize: 10
	}, o = {
	...
	return fi(e, l), hi(e, l), r.row_count = c.pagination?.total || 0, e.current = r, t(), {
		rows: _i(e),
		rowCount: c.pagination?.total || 0
	};
} }), ki = (e, t) => {
	...
	let n = e.current;
	n && (n.datasource = t, e.current = n, await Mi(e));
	...
	let t = e.current;
	if (t) return t.cellRenderer ? t.cellRenderer(e) : Ii(e);
}, Ii = (e) => {
	let t = Xn();
	return (n) => {
		let r = e.current;
...
}, Li = ({ api: e, endpoint: t, row_details: n, refKey: r, cellRenderer: i, register_component: o = !1, toolbar: l = !1, checkbox_select: u = !1, datagrid_sx: d = void 0, grid_options: f = void 0, context: p = void 0 }) => {
...
}, Ri = ({ loading: e, value: t }) => /* @__PURE__ */ k(u, {
	sx: {
		position: "relative",
		display: "inline-flex"
	},
...
}, Vi = (e) => !e || !e.current ? 1 : e.current.progressValue, Hi = (e, t) => {
	let n = e.current;
	n && n.handleToggle(t);
}, Ui = ({ refKey: e, register_component: t, hidden: r, onDropSuccess: i, onSend: o, textFieldSx: l, textFieldProps: u, sendButtonProps: d }) => {
	let [f, p] = c(""), [m, h] = c(!1), [g, _] = c(0), v = Qn(e, t), b = s({
		handleToggle: (e) => {
			h(e);
		},
		progressValue: 0,
	...
	let { ref: E, ...D } = S(), ee = m ? /* @__PURE__ */ k(Ri, {
		loading: !0,
		value: g
	}) : /* @__PURE__ */ k(zi, {
		onClick: o(b),
...
}), qi = ({ children: e, theme: t }) => {
	let n = Ki;
	return t || (n = Ki), /* @__PURE__ */ k(Gi, { children: /* @__PURE__ */ A(te, {
		theme: n,
		children: [/* @__PURE__ */ k(m, {}), /* @__PURE__ */ k(Wi, { children: /* @__PURE__ */ k(T, {
			direction: "column",
			sx: {
				width: "100%",
				justifyContent: "center",
	...
	return /* @__PURE__ */ A(T, {
		...
		children: [/* @__PURE__ */ k(d, {
			...
			children: /* @__PURE__ */ k(ae, { children: e.map((e) => (Q(e.props.grid_options) && (e.props.grid_options = { onRowSelectionModelChange: i(e.props.refKey) }), /* @__PURE__ */ k(e.table, { ...e.props }))) })
		})]
	});
}, Qi = (e) => {
	let [t, n] = c(""), r = At(), i = async (e) => {
		let i = { current: r?.get(t) }, a = e.target.value;
		zn(i, a), n(e.target.value), await Vn(i);
	};
	return /* @__PURE__ */ k(T, {
		spacing: 3,
		sx: {
...
//#endregion
export { Zr as AddElement, Pr as Api, tr as ApiButton, Jn as AppController, mr as AppendChildren, xr as BuildContainerTree, nr as CenteredContainer, rr as CenteredModal, Ur as Close, Zi as CompareTables, ri as Create, Rr as CsvDatagridSx, zr as CsvGrid, Oi as DataSourceWrapper, Ji as DatagridSx, oi as Delete, $r as DeleteLabel, ai as DeleteMany, si as EditCellRenderer, Yi as FieldValueGrid, ui as GetApi, Fi as GetCellRenderer, ur as GetChildren, $ as GetContainer, ji as GetDatasource, Qr as GetElementIndex, Xr as GetElementTypes, Yr as GetElementValue, qr as GetElements, li as GetEndpoint, Di as GetFetchParams, yi as GetHeaders, gi as GetKeyValueRows, bi as GetPaginationModel, lr as GetParent, fr as GetPath, Vi as GetProgressValue, vi as GetRawHeaders, _i as GetRows, Kr as GetSet, dr as GetValue, Lr as GridWithButtons, qi as HFCenteredLayout, Fr as HandleGet, Wi as HeaderFooterLayout, Hr as InitialTypeFormBuilderRefState, Q as IsNullOrUndefined, ir as IsPrimitive, Ii as ModalCellRendererWrapper, pr as NewObject, Ri as ProgressAdornment, vr as RangeContainers, yr as RangePrimitiveValues, _r as RangeValues, gr as ReadFromContainers, hr as ReadFromValue, Yn as RefIndexContext, Gi as RefProvider, Mi as Refresh, Br as SelectAssociation, zi as SendIconButton, di as SetApi, xi as SetArgs, Pi as SetCellRenderer, Gr as SetContainer, Ai as SetDatasource, ci as SetEndpoint, Ei as SetFetchParams, wi as SetFilterModel, Wr as SetHandleClose, fi as SetHeadersFromJson, pi as SetKeyValueHeaders, mi as SetKeyValueRows, Hi as SetLoading, Si as SetOrAddArgs, Ti as SetPaginationModel, Bi as SetProgressValue, hi as SetRowsFromJson, ki as SetSearch, Ni as SetSelectedRows, Ci as SetSortModel, Xi as SetTableState, ar as TitleCase, ei as TypeFormBuilder, ti as TypeFormBuilderModal, $n as UIAppBar, er as UIBottomNav, Ui as UIInput, Li as UITable, ii as Update, br as UpdateContainerByPath, Jr as UpdateElementValues, Qi as VectorSearch, cr as createContainer, Qn as useConditionalRef, Zn as useManagedRef, Xn as useRefIndex };
