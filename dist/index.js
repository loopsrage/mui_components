...
import ce from "@mui/icons-material/BugReport";
import le from "@mui/icons-material/Home";
import ue from "@mui/icons-material/Settings";
//#region \0rolldown/runtime.js
var K = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), q = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), J = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), de = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), Y = t(null), fe = () => r(Y), pe = (e, t = !0) => {
	let n = fe();
	return (r) => {
		t && r ? n?.register(e, r) : n?.unregister(e);
	};
}, me = ({ title: e, body: t, show: n, footer: r, title_sx: i, footer_sx: a, content_sx: o, paper_sx: s }) => /* @__PURE__ */ j(h, {
	open: n,
	maxWidth: "lg",
	fullWidth: !0,
	scroll: "paper",
...
}, X = (e) => e == null, ge = (e, t) => X(e) ? "" : e.split(t).map((e) => e.charAt(0).toUpperCase() + e.slice(1)).join(" "), _e = "Values", ve = "Containers", ye = (e, t, n, r) => {
	let i = r || {
		[_e]: /* @__PURE__ */ new Map(),
		[ve]: /* @__PURE__ */ new Map()
	}, a = e ? t : "root", o = {
	...
	return e || (o.root = o), i[_e].set(a, n), i[ve].set(a, o), Object.freeze(o);
}, be = (e, t, n) => {
...
}, xe = (e, t) => e.containerIndex[ve].get(t), Se = (e, t) => {
	for (let [n, r] of e.containerIndex[_e].entries()) t(n, r);
}, Ce = (e, t) => {
	for (let [, n] of e.containerIndex[ve].entries()) t(n);
}, we = (e, t, n = 2) => {
	Se(e, (e, r) => {
		let i = Object.keys(r);
	...
	if (!e || !t) return e;
	let i = e.containerIndex[ve].get(t);
	...
	e.containerIndex[ve].set(t, s), e.containerIndex[_e].set(t, o);
	let c = s;
	for (; c.parent;) {
		let t = c.parent, n = t.children.map((e) => e.path === c.path ? c : e), r = c.path.split("."), i = r.slice(r.length - 1), a = { ...e.containerIndex[_e].get(t.path) };
		a[i] = o;
		let s = Object.freeze({
			...t,
			children: n,
		...
		e.containerIndex[ve].set(s.path, s), c = s;
	}
	return e.containerIndex[ve].get("root");
}, Ee = (e = null, t = [], n = "_", ...r) => {
	...
	function ee(e, t, n, r) {
		return K(le(t, e.length - n), e, n, r);
	}
	...
	return X(t) && (t = "png"), X(n) && (n = "ERROR"), Ne(new Blob([Pe(e)])).then((e) => {
	...
	let a = {
		...
		return X(l) || (f.method === "POST" && (f.body = JSON.stringify(l)), f.method === "GET" && (u += Le(l))), fetch(u, f).catch((e) => n(e)).finally(() => {
			i && o({
				endpoint: t,
				inputHeaders: s,
				fetchParams: c
...
var ze = ({ endpoint: e, handleErr: t }) => {
	...
	if (r === "object") {
		...
		if (i.defaultValue.Subtype === 19) return /* @__PURE__ */ A(Ot, { data: xe(Ye(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 17) return /* @__PURE__ */ A(Ie, { data: xe(Ye(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 16 || i.defaultValue.Subtype === 0) {
			let r = xe(Ye(e), n.slice(0, n.lastIndexOf(".")));
...
}, Ye = (e) => e.current.container, Xe = (e, t) => {
	...
	return { onChange: (n) => {
		...
		X(xe(Ye(e), c)) && (c = s.slice(0, s.length - 2).join(".")), n.target.type === "checkbox" && (r = n.currentTarget.checked), e.current = t, Je(e, Te(Ye(e), c, l, r)), e.current = t;
	} };
}, $e = (e, t) => {
	...
	let r = e.current, i = ge(t.replace(/root\./, ""), "_"), a = i.split(".");
	...
	let g = pe(p, m), _ = s(null), [v, y] = c(!1), b = () => {
		y(!1);
	}, x = () => {
		o(Ye(_).value), y(!1);
	};
	...
	let [S, C] = c(void 0), [w, E] = c(0), O = async () => {
		try {
			Je(_, Ee(null, [], ".", await i())), qe(_, b), nt({
				formRef: _,
				container: Ye(_)
			}), C(Ze(_)), y(!0);
		} catch (e) {
	...
	return f ||= [
		/* @__PURE__ */ A(d, {
			onClick: () => {
				...
				e[_.current.index] = "";
				let t = Ye(_);
				X(xe(t, "root.fields")) && Je(_, be(t, "root.fields", {})), tt(_, "root.fields." + _.current.index, e), C(Ze(_));
			},
			children: "Add Field"
		}),
		/* @__PURE__ */ A(d, {
		...
		children: [n ? n(O) : /* @__PURE__ */ A(d, {
			...
			body: /* @__PURE__ */ j(u, {
				...
				children: [
					...
					w === 1 && /* @__PURE__ */ A(u, {
						sx: { p: 3 },
						children: /* @__PURE__ */ A("pre", { children: JSON.stringify(Ye(_)?.value, null, 2) })
					})
				]
			}),
			show: v,
...
}, it = ({ title: e, show: t, onCancel: n, onConfirm: r }) => /* @__PURE__ */ A(me, {
...
}), at = ({ refreshGrid: e, api: t, id: n, title: r, footerButtons: i, ...a }) => /* @__PURE__ */ A(rt, {
	title: r,
	button_title: "Update",
	getSchema: Be(t, n),
	handleSave: (r) => {
	...
	return /* @__PURE__ */ j(T, {
		...
		children: [/* @__PURE__ */ A(at, { ...i }), /* @__PURE__ */ A(ot, { ...i })]
	});
}, ct = (e, t) => {
	let n = e.current;
	we(t, (e) => {
	...
	Object.entries(t).forEach(([e, t]) => {
		if (r !== void 0 && n.rows[r].push(ge(e, "_")), i !== void 0) {
	...
	let m = pe(r, o), h = s(null), [, g] = c(!1), [_, v] = c({
		page: 0,
		pageSize: 25
...
var Dt = () => {
...
}, Mt = ({ title: e, body: t, show: n, footer: r, title_sx: i, footer_sx: a, content_sx: o, paper_sx: s }) => /* @__PURE__ */ j(h, {
	open: n,
	maxWidth: "lg",
	fullWidth: !0,
	scroll: "paper",
	...
	let t = typeof e;
	return t === "string" || t === "number" || t === "boolean" || t === "undefined" || t === "symbol" || t === "bigint" || t === "int";
}, Z = (e) => e == null, Pt = (e, t) => Z(e) ? "" : e.split(t).map((e) => e.charAt(0).toUpperCase() + e.slice(1)).join(" "), Ft = "Values", It = "Containers", Lt = (e, t, n, r) => {
	let i = r || {
		[Ft]: /* @__PURE__ */ new Map(),
		[It]: /* @__PURE__ */ new Map()
	}, a = e ? t : "root", o = {
...
}, qt = ({ fileData: e, subtype: t, inputProps: n }) => /* @__PURE__ */ A(u, {
	sx: { width: "100%" },
	children: /* @__PURE__ */ A(C, {
		variant: "outlined",
		sx: {
	...
	return Z(t) && (t = "png"), Z(n) && (n = "ERROR"), Zt(new Blob([Qt(e)])).then((e) => {
	...
	let a = {
		...
		return Z(l) || (f.method === "POST" && (f.body = JSON.stringify(l)), f.method === "GET" && (u += tn(l))), fetch(u, f).catch((e) => n(e)).finally(() => {
			i && o({
				endpoint: t,
				inputHeaders: s,
				fetchParams: c
...
var rn = ({ endpoint: e, handleErr: t }) => {
	...
	if (r === "object") {
		if (i.defaultValue.Subtype === 20) return /* @__PURE__ */ A(cn, {
			api: e.current?.api,
			refKey: "csv_grid",
			register_component: !0
		}, t);
		if (i.defaultValue.Subtype === 19) return /* @__PURE__ */ A(qn, { data: zt(mn(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 17) return /* @__PURE__ */ A(en, { data: zt(mn(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 16 || i.defaultValue.Subtype === 0) {
			let r = zt(mn(e), n.slice(0, n.lastIndexOf(".")));
			return i.name = n.slice(0, n.lastIndexOf(".")) + ".Data", /* @__PURE__ */ A(qt, {
				fileData: JSON.stringify(r?.value.Data, null, 2),
				inputProps: i,
				subtype: i.defaultValue.Subtype
			}, t);
...
}, mn = (e) => e.current.container, hn = (e, t) => {
	let n = e.current, r = n.labels[t], i = n.element_component[t];
	return n.useLabels[t] ? /* @__PURE__ */ j(T, {
		direction: "column",
		spacing: 1,
	...
	return { onChange: (n) => {
		...
		let s = a.split("."), c = s.slice(0, s.length - 1).join("."), l = s.slice(s.length - 1);
		Z(zt(mn(e), c)) && (c = s.slice(0, s.length - 2).join(".")), n.target.type === "checkbox" && (r = n.currentTarget.checked), e.current = t, pn(e, Ut(mn(e), c, l, r)), e.current = t;
	} };
}, vn = (e, t) => {
	let n = e.current, r = n.nameIndex[t];
	return n.elements[r];
	...
	Vt(t, (t) => {
		...
		Object.keys(r).forEach((t) => {
			Z(r[t]) || (typeof r[t] == "object" && Object.keys(r[t]).forEach((i) => {
				let a = {};
				a[i] = r[t][i], bn(e, n + "." + t + "." + i, a);
			}), Nt(r[t]) && bn(e, n + "." + t, r[t]));
		});
	});
}, Sn = ({ title: e, button_title: t, getButton: n, tabs: r, getSchema: i, handleSave: o, elementSelector: l, footerButtons: f, refKey: p, register_component: m = !1, context: h = null }) => {
	...
	let [S, C] = c(void 0), [w, E] = c(0), O = async () => {
		try {
			pn(_, Wt(null, [], ".", await i())), fn(_, b), xn({
				formRef: _,
				container: mn(_)
			}), C(gn(_)), y(!0);
		} catch (e) {
	...
	return f ||= [
		/* @__PURE__ */ A(d, {
			onClick: () => {
				...
				e[_.current.index] = "";
				let t = mn(_);
				Z(zt(t, "root.fields")) && pn(_, Rt(t, "root.fields", {})), bn(_, "root.fields." + _.current.index, e), C(gn(_));
			},
			children: "Add Field"
		}),
		/* @__PURE__ */ A(d, {
		...
		children: [n ? n(O) : /* @__PURE__ */ A(d, {
			...
			body: /* @__PURE__ */ j(u, {
				...
				children: [
					...
					w === 1 && /* @__PURE__ */ A(u, {
						sx: { p: 3 },
						children: /* @__PURE__ */ A("pre", { children: JSON.stringify(mn(_)?.value, null, 2) })
					})
				]
			}),
			show: v,
...
}, Cn = ({ title: e, show: t, onCancel: n, onConfirm: r }) => /* @__PURE__ */ A(Mt, {
	title: e || "Are you sure?",
	show: t,
	footer: /* @__PURE__ */ j(T, {
		direction: "column",
...
}), wn = ({ refreshGrid: e, api: t, id: n, title: r, footerButtons: i, ...a }) => /* @__PURE__ */ A(Sn, {
	title: r,
	button_title: "Update",
	getSchema: an(t, n),
	handleSave: (r) => {
...
}, En = ({ handleRefreshGrid: e, api: t, id: n, params: r }) => {
	let i = {
		...r,
		refreshGrid: e,
		api: t,
	...
	return /* @__PURE__ */ j(T, {
		...
		children: [/* @__PURE__ */ A(wn, { ...i }), /* @__PURE__ */ A(Tn, { ...i })]
	});
}, Dn = (e, t) => {
	let n = e.current;
	Ht(t, (e) => {
	...
	let n = e.current;
	n && (n.args.filterModel = JSON.stringify(t), e.current = n);
}, Rn = (e) => e.current.fetch_params, zn = (e, t) => ({ getRows: async (n) => {
	let r = e.current;
	if (!r) return {
		rows: [],
		rowCount: 0
	};
	Ln(e, n.filterModel), In(e, n.sortModel);
	let { page: i, pageSize: a } = n.paginationModel ?? {
		page: 0,
		pageSize: 10
	}, o = {
	...
	return Dn(e, l), An(e, l), r.row_count = c.pagination?.total || 0, e.current = r, t(), {
		rows: Mn(e),
		rowCount: c.pagination?.total || 0
	};
...
var Kn = () => {
...
}, Jn = t(null), Yn = () => r(Jn), Xn = (e, t = !0) => {
	let n = Yn();
	return (r) => {
		t && r ? n?.register(e, r) : n?.unregister(e);
	};
}, Zn = ({ title: e, body: t, show: n, footer: r, title_sx: i, footer_sx: a, content_sx: o, paper_sx: s }) => /* @__PURE__ */ j(h, {
	open: n,
	maxWidth: "lg",
	fullWidth: !0,
	scroll: "paper",
	...
	let t = typeof e;
	return t === "string" || t === "number" || t === "boolean" || t === "undefined" || t === "symbol" || t === "bigint" || t === "int";
}, Q = (e) => e == null, $n = (e, t) => Q(e) ? "" : e.split(t).map((e) => e.charAt(0).toUpperCase() + e.slice(1)).join(" "), er = "Values", tr = "Containers", nr = (e, t, n, r) => {
	let i = r || {
		[er]: /* @__PURE__ */ new Map(),
		[tr]: /* @__PURE__ */ new Map()
	}, a = e ? t : "root", o = {
	...
	return e || (o.root = o), i[er].set(a, n), i[tr].set(a, o), Object.freeze(o);
}, rr = (e, t, n) => {
	let r = nr(e, t, n, e.containerIndex);
	return {
		...e,
		children: [...e.children, r]
	};
}, ir = (e, t) => e.containerIndex[tr].get(t), ar = (e, t) => {
	for (let [n, r] of e.containerIndex[er].entries()) t(n, r);
}, or = (e, t) => {
	for (let [, n] of e.containerIndex[tr].entries()) t(n);
}, sr = (e, t, n = 2) => {
	ar(e, (e, r) => {
		let i = Object.keys(r);
		for (let a = 0; a < i.length; a++) {
	...
	if (!e || !t) return e;
	let i = e.containerIndex[tr].get(t);
	if (!i) return console.warn(`Container at path "${t}" not found.`), e;
	let a = {};
	a[n] = r;
	let o = {
		...i.value,
		...a
	}, s = nr(i.parent, i.path, o, e.containerIndex);
	e.containerIndex[tr].set(t, s), e.containerIndex[er].set(t, o);
	let c = s;
	for (; c.parent;) {
		let t = c.parent, n = t.children.map((e) => e.path === c.path ? c : e), r = c.path.split("."), i = r.slice(r.length - 1), a = { ...e.containerIndex[er].get(t.path) };
		a[i] = o;
		let s = Object.freeze({
			...t,
			children: n,
		...
		e.containerIndex[tr].set(s.path, s), c = s;
	}
	return e.containerIndex[tr].get("root");
}, lr = (e = null, t = [], n = "_", ...r) => {
	e === null && (e = nr(null, "root", r.length === 0 ? {} : r[0]), t = ["root"]);
	let i = (e, t) => {
		let r = e.value;
		return typeof r == "object" && r && (Array.isArray(r) ? r.forEach((r, a) => {
			if (typeof r == "object" && r) {
				let o = [...t, String(a)];
				i(rr(e, o.join(n), r).children.at(-1), o);
			}
		}) : Object.entries(r).forEach(([r, a]) => {
			if (typeof a == "object" && a) {
				let o = [...t, r];
				i(rr(e, o.join(n), a).children.at(-1), o);
			}
		})), e;
	};
	return i(e, t);
}, ur = ({ inputKey: t, inputProps: n }) => {
	let r = Object.keys(n.defaultValue)[0], a = n.defaultValue[r], [o, s] = c(/* @__PURE__ */ A(b, {
		type: "text",
		onChange: n.onChange,
		defaultValue: a
...
}, fr = ({ fileData: e, subtype: t, inputProps: n }) => /* @__PURE__ */ A(u, {
	sx: { width: "100%" },
	children: /* @__PURE__ */ A(C, {
		variant: "outlined",
		sx: {
	...
	for (let t = 0; t < e.length; t++) n[t] = e.charCodeAt(t);
	return n;
}, vr = "data:image/#{encoding};base64,#{data}", yr = ({ data: e, encoding: t, alt: n }) => {
	let r = vr, [i, a] = c(void 0);
	return Q(t) && (t = "png"), Q(n) && (n = "ERROR"), gr(new Blob([_r(e)])).then((e) => {
		r = r.replace("#{encoding}", t), r = r.replace("#{data}", hr.Buffer.from(e).toString("base64")), a(r);
	}), /* @__PURE__ */ A(Box, {
		component: "img",
		src: i,
		alt: n,
	...
	return t;
}, xr = (e, { baseHeaders: t, handleErr: n, handleFinally: r, debug: i } = {}) => {
	let a = {
		"Content-Type": "application/json",
		...t
	}, o = (e) => {
		...
		return Q(l) || (f.method === "POST" && (f.body = JSON.stringify(l)), f.method === "GET" && (u += br(l))), fetch(u, f).catch((e) => n(e)).finally(() => {
			i && o({
				endpoint: t,
				inputHeaders: s,
				fetchParams: c
...
xr("http://localhost:8080/", {
	handleErr: (e) => console.log(e),
	debug: !0
});
var Sr = ({ endpoint: e, handleErr: t }) => {
	Q(t) && (t = (e) => console.log(e));
	let n = xr(e, { handleErr: t });
	return {
		at: async (e, t) => await n.fetchJson({
			endpoint: e,
			...t
...
}, Cr = (e, t) => () => e.get(t), wr = ({ jsxKey: e, endpoint: t, inputProps: n }) => {
	let [r, a] = c([/* @__PURE__ */ A("option", {
		value: n.defaultValue,
		children: n.defaultValue
	}, e + "-" + n.defaultValue)]), o = Sr({ endpoint: t });
	return i(() => {
		o.selectOptions().then((t) => {
			a(Object.keys(t).map((n) => {
				let r = t[n][Object.keys(t[n])[1]], i = t[n][Object.keys(t[n])[0]];
...
}, Tr = ({ buttons: e, endpoint: t, title: n, title_topology_params: r, button_stack_params: i, header_stack_params: a, outer_stack_params: o, ...s }) => {
	let c = e?.map((e) => e);
	return /* @__PURE__ */ j(T, {
		direction: "column",
		spacing: 1,
...
}, Er = ({ api: e, endpoint: t, refKey: n, register_component: r, ...a }) => {
	let o = Yn();
	return i(() => {
		(async () => {
			let e = o?.get(n);
...
}, Dr = ({ jsxKey: e, key: t, inputProps: n }) => {
	let r;
	return t.charAt(t.length - 1) === "D" && t.charAt(t.length - 2) === "I" || t.charAt(t.length - 1) === "S" && t.charAt(t.length - 2) === "D" ? (t.charAt(t.length - 1) === "D" && t.charAt(t.length - 2) === "I" && (r = t.slice(5, t.length - 2)), t.charAt(t.length - 1) === "S" && t.charAt(t.length - 2) === "D" && (r = t.slice(5, t.length - 3), n = {
		...n,
		multiple: !0
...
}, Or = () => ({ formRef: e, jsxKey: t, key: n, currentType: r, inputProps: i }) => {
	let a = Dr({
		jsxKey: t,
		key: n,
		inputProps: i
	...
	if (r === "object") {
		if (i.defaultValue.Subtype === 20) return /* @__PURE__ */ A(Er, {
			api: e.current?.api,
			refKey: "csv_grid",
			register_component: !0
		}, t);
		if (i.defaultValue.Subtype === 19) return /* @__PURE__ */ A(fi, { data: ir(Mr(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 17) return /* @__PURE__ */ A(yr, { data: ir(Mr(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 16 || i.defaultValue.Subtype === 0) {
			let r = ir(Mr(e), n.slice(0, n.lastIndexOf(".")));
			return i.name = n.slice(0, n.lastIndexOf(".")) + ".Data", /* @__PURE__ */ A(fr, {
				fileData: JSON.stringify(r?.value.Data, null, 2),
				inputProps: i,
				subtype: i.defaultValue.Subtype
			}, t);
...
}, Mr = (e) => e.current.container, Nr = (e, t) => {
	let n = e.current, r = n.labels[t], i = n.element_component[t];
	return n.useLabels[t] ? /* @__PURE__ */ j(T, {
		direction: "column",
		spacing: 1,
	...
	return { onChange: (n) => {
		...
		let s = a.split("."), c = s.slice(0, s.length - 1).join("."), l = s.slice(s.length - 1);
		Q(ir(Mr(e), c)) && (c = s.slice(0, s.length - 2).join(".")), n.target.type === "checkbox" && (r = n.currentTarget.checked), e.current = t, jr(e, cr(Mr(e), c, l, r)), e.current = t;
	} };
}, Ir = (e, t) => {
	let n = e.current, r = n.nameIndex[t];
	return n.elements[r];
	...
	let r = e.current, i = $n(t.replace(/root\./, ""), "_"), a = i.split(".");
	if (!a.some((e) => e.toLowerCase() === "data")) {
		if (Q(r.nameIndex[t])) {
			r.nameIndex[t] = r.index, r.elements[r.index] = n;
			let o = Lr(e, t, n);
	...
	or(t, (t) => {
		...
		Object.keys(r).forEach((t) => {
			Q(r[t]) || (typeof r[t] == "object" && Object.keys(r[t]).forEach((i) => {
				let a = {};
				a[i] = r[t][i], Rr(e, n + "." + t + "." + i, a);
			}), Qn(r[t]) && Rr(e, n + "." + t, r[t]));
		});
	});
}, Br = ({ title: e, button_title: t, getButton: n, tabs: r, getSchema: i, handleSave: o, elementSelector: l, footerButtons: f, refKey: p, register_component: m = !1, context: h = null }) => {
	let g = Xn(p, m), _ = s(null), [v, y] = c(!1), b = () => {
		y(!1);
	}, x = () => {
		o(Mr(_).value), y(!1);
	};
	...
	let [S, C] = c(void 0), [w, E] = c(0), O = async () => {
		try {
			jr(_, lr(null, [], ".", await i())), Ar(_, b), zr({
				formRef: _,
				container: Mr(_)
			}), C(Pr(_)), y(!0);
		} catch (e) {
	...
	return f ||= [
		/* @__PURE__ */ A(d, {
			onClick: () => {
				...
				e[_.current.index] = "";
				let t = Mr(_);
				Q(ir(t, "root.fields")) && jr(_, rr(t, "root.fields", {})), Rr(_, "root.fields." + _.current.index, e), C(Pr(_));
			},
			children: "Add Field"
		}),
		/* @__PURE__ */ A(d, {
		...
		children: [n ? n(O) : /* @__PURE__ */ A(d, {
			...
			body: /* @__PURE__ */ j(u, {
				...
				children: [
					...
					w === 1 && /* @__PURE__ */ A(u, {
						sx: { p: 3 },
						children: /* @__PURE__ */ A("pre", { children: JSON.stringify(Mr(_)?.value, null, 2) })
					})
				]
			}),
			show: v,
...
}, Vr = ({ title: e, show: t, onCancel: n, onConfirm: r }) => /* @__PURE__ */ A(Zn, {
	title: e || "Are you sure?",
	show: t,
	footer: /* @__PURE__ */ j(T, {
		direction: "column",
...
}), Hr = ({ refreshGrid: e, api: t, id: n, title: r, footerButtons: i, ...a }) => /* @__PURE__ */ A(Br, {
	title: r,
	button_title: "Update",
	getSchema: Cr(t, n),
	handleSave: (r) => {
...
}, Wr = ({ handleRefreshGrid: e, api: t, id: n, params: r }) => {
	let i = {
		...r,
		refreshGrid: e,
		api: t,
	...
	return /* @__PURE__ */ j(T, {
		...
		children: [/* @__PURE__ */ A(Hr, { ...i }), /* @__PURE__ */ A(Ur, { ...i })]
	});
}, Gr = (e, t) => {
	let n = e.current;
	sr(t, (e) => {
	...
	let r = n.headers_ri.Field, i = n.headers_ri.Value;
	Object.entries(t).forEach(([e, t]) => {
		if (r !== void 0 && n.rows[r].push($n(e, "_")), i !== void 0) {
			let e = Array.isArray(t) ? t.join(", ") : t;
			n.rows[i].push(e);
		}
		n.row_count++;
	...
	let n = e.current;
	n && (n.args.filterModel = JSON.stringify(t), e.current = n);
}, ni = (e) => e.current.fetch_params, ri = (e, t) => ({ getRows: async (n) => {
	let r = e.current;
	if (!r) return {
		rows: [],
		rowCount: 0
	};
	ti(e, n.filterModel), ei(e, n.sortModel);
	let { page: i, pageSize: a } = n.paginationModel ?? {
		page: 0,
		pageSize: 10
	}, o = {
	...
	return Gr(e, l), Jr(e, l), r.row_count = c.pagination?.total || 0, e.current = r, t(), {
		rows: Xr(e),
		rowCount: c.pagination?.total || 0
	};
} }), ii = (e, t) => {
	...
	let m = Xn(r, o), h = s(null), [, g] = c(!1), [_, v] = c({
		page: 0,
		pageSize: 25
	}), [y, b] = c(0), [x, S] = c({ id: !1 }), C = P(), w = () => {
		h.current && b(h.current?.row_count ?? 0), g((e) => !e);
...
var di = () => {
	...
	let t = Yn(), n = Xn("app_ctrl", !0), [r, o] = c(e), l = s({
		active: e,
		setActive: (e) => {
			o(e);
		}
	...
	return i(() => {
		...
		n && n.register_element({
			home: /* @__PURE__ */ A(y, {
				...
				sx: { color: "white" },
				onClick: () => o(e),
				children: /* @__PURE__ */ A(le, { fontSize: "small" })
			}),
			settings: /* @__PURE__ */ A(y, {
				size: "small",
				sx: { color: "white" },
				onClick: () => console.log("debug clicked"),
				children: /* @__PURE__ */ A(ue, { fontSize: "small" })
			}),
			debug: /* @__PURE__ */ A(y, {
				size: "small",
				sx: { color: "white" },
				onClick: () => console.log("debug clicked"),
				children: /* @__PURE__ */ A(ce, { fontSize: "small" })
			})
		});
	}, [t]), a(() => (n(l), () => n(null)), [n]), r;
}, mi = t(null), hi = () => r(mi), gi = (e) => {
	let t = hi();
	return (n) => {
...
}, vi = ({ title: e, appbar_sx: t, refKey: n, register_component: r }) => {
	let [i, o] = c({}), d = _i(n, r), f = s({ register_element: (e) => {
		o({
			...i,
			...e
		});
...
}), bi = ({ api: e, endpoint: t, children: n, get_args: r, fetch_params: i, callback: a, ...o }) => /* @__PURE__ */ A(d, {
	onClick: async () => {
		try {
			let n = {};
			r && (n = r());
	...
	...o,
	children: n
}), xi = ({ children: e, sx: t = {} }) => /* @__PURE__ */ A(u, {
	sx: {
		display: "flex",
		flexDirection: "column",
		justifyContent: "center",
	...
	let t = typeof e;
	return t === "string" || t === "number" || t === "boolean" || t === "undefined" || t === "symbol" || t === "bigint" || t === "int";
}, $ = (e) => e == null, wi = (e, t) => $(e) ? "" : e.split(t).map((e) => e.charAt(0).toUpperCase() + e.slice(1)).join(" "), Ti = "Values", Ei = "Containers", Di = (e, t, n, r) => {
	let i = r || {
		[Ti]: /* @__PURE__ */ new Map(),
		[Ei]: /* @__PURE__ */ new Map()
	}, a = e ? t : "root", o = {
	...
	return e || (o.root = o), i[Ti].set(a, n), i[Ei].set(a, o), Object.freeze(o);
}, Oi = (e) => e.parent || null, ki = (e) => [...e.children], Ai = (e) => e.value, ji = (e) => e.path, Mi = (e, t, n) => {
	let r = Di(e, t, n, e.containerIndex);
	return {
		...e,
		children: [...e.children, r]
	};
...
}), Pi = (e, t) => e.containerIndex[Ti].get(t), Fi = (e, t) => e.containerIndex[Ei].get(t), Ii = (e, t) => {
	for (let [n, r] of e.containerIndex[Ti].entries()) t(n, r);
}, Li = (e, t) => {
	for (let [, n] of e.containerIndex[Ei].entries()) t(n);
}, Ri = (e, t, n = 2) => {
	Ii(e, (e, r) => {
		let i = Object.keys(r);
		for (let a = 0; a < i.length; a++) {
	...
	if (!e || !t) return e;
	let i = e.containerIndex[Ei].get(t);
	if (!i) return console.warn(`Container at path "${t}" not found.`), e;
	let a = {};
	a[n] = r;
	let o = {
		...i.value,
		...a
	}, s = Di(i.parent, i.path, o, e.containerIndex);
	e.containerIndex[Ei].set(t, s), e.containerIndex[Ti].set(t, o);
	let c = s;
	for (; c.parent;) {
		let t = c.parent, n = t.children.map((e) => e.path === c.path ? c : e), r = c.path.split("."), i = r.slice(r.length - 1), a = { ...e.containerIndex[Ti].get(t.path) };
		a[i] = o;
		let s = Object.freeze({
			...t,
			children: n,
		...
		e.containerIndex[Ei].set(s.path, s), c = s;
	}
	return e.containerIndex[Ei].get("root");
}, Bi = (e = null, t = [], n = "_", ...r) => {
	e === null && (e = Di(null, "root", r.length === 0 ? {} : r[0]), t = ["root"]);
	let i = (e, t) => {
		let r = e.value;
		return typeof r == "object" && r && (Array.isArray(r) ? r.forEach((r, a) => {
			if (typeof r == "object" && r) {
...
}, Hi = ({ fileData: e, onChange: t, name: n }) => {
	let [r] = z(), a = s("");
	return i(() => {
		e && (async () => {
			if (!e) return;
...
}, Ui = ({ fileData: e, subtype: t, inputProps: n }) => /* @__PURE__ */ A(u, {
	sx: { width: "100%" },
	children: /* @__PURE__ */ A(C, {
		variant: "outlined",
		sx: {
	...
	var t = Wi(), n = Gi(), r = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
	e.Buffer = s, e.SlowBuffer = v, e.INSPECT_MAX_BYTES = 50;
	var i = 2147483647;
	e.kMaxLength = i, s.TYPED_ARRAY_SUPPORT = a(), !s.TYPED_ARRAY_SUPPORT && typeof console < "u" && typeof console.error == "function" && console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");
	function a() {
	...
	for (let t = 0; t < e.length; t++) n[t] = e.charCodeAt(t);
	return n;
}, Yi = "data:image/#{encoding};base64,#{data}", Xi = ({ data: e, encoding: t, alt: n }) => {
	let r = Yi, [i, a] = c(void 0);
	return $(t) && (t = "png"), $(n) && (n = "ERROR"), qi(new Blob([Ji(e)])).then((e) => {
		r = r.replace("#{encoding}", t), r = r.replace("#{data}", Ki.Buffer.from(e).toString("base64")), a(r);
	}), /* @__PURE__ */ A(Box, {
		component: "img",
		src: i,
		alt: n,
	...
	let a = {
		...
		return $(l) || (f.method === "POST" && (f.body = JSON.stringify(l)), f.method === "GET" && (u += Zi(l))), fetch(u, f).catch((e) => n(e)).finally(() => {
			i && o({
				endpoint: t,
				inputHeaders: s,
				fetchParams: c
...
var $i = ({ endpoint: e, handleErr: t }) => {
...
}, ea = (e, t) => () => e.get(t), ta = ({ jsxKey: e, endpoint: t, inputProps: n }) => {
	let [r, a] = c([/* @__PURE__ */ A("option", {
		value: n.defaultValue,
		children: n.defaultValue
	}, e + "-" + n.defaultValue)]), o = $i({ endpoint: t });
	return i(() => {
		o.selectOptions().then((t) => {
			a(Object.keys(t).map((n) => {
				let r = t[n][Object.keys(t[n])[1]], i = t[n][Object.keys(t[n])[0]];
...
}, na = ({ buttons: e, endpoint: t, title: n, title_topology_params: r, button_stack_params: i, header_stack_params: a, outer_stack_params: o, ...s }) => {
	let c = e?.map((e) => e);
	return /* @__PURE__ */ j(T, {
		direction: "column",
		spacing: 1,
...
}, ia = ({ api: e, endpoint: t, refKey: n, register_component: r, ...a }) => {
	let o = hi();
	return i(() => {
		(async () => {
			let e = o?.get(n);
...
}, aa = ({ jsxKey: e, key: t, inputProps: n }) => {
	let r;
	return t.charAt(t.length - 1) === "D" && t.charAt(t.length - 2) === "I" || t.charAt(t.length - 1) === "S" && t.charAt(t.length - 2) === "D" ? (t.charAt(t.length - 1) === "D" && t.charAt(t.length - 2) === "I" && (r = t.slice(5, t.length - 2)), t.charAt(t.length - 1) === "S" && t.charAt(t.length - 2) === "D" && (r = t.slice(5, t.length - 3), n = {
		...n,
		multiple: !0
...
}, oa = () => ({ formRef: e, jsxKey: t, key: n, currentType: r, inputProps: i }) => {
	let a = aa({
		jsxKey: t,
		key: n,
		inputProps: i
	...
	if (r === "object") {
		if (i.defaultValue.Subtype === 20) return /* @__PURE__ */ A(ia, {
			api: e.current?.api,
			refKey: "csv_grid",
			register_component: !0
		}, t);
		if (i.defaultValue.Subtype === 19) return /* @__PURE__ */ A(go, { data: Fi(da(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 17) return /* @__PURE__ */ A(Xi, { data: Fi(da(e), n.slice(0, n.lastIndexOf(".")))?.value.Data }, t);
		if (i.defaultValue.Subtype === 16 || i.defaultValue.Subtype === 0) {
			let r = Fi(da(e), n.slice(0, n.lastIndexOf(".")));
			return i.name = n.slice(0, n.lastIndexOf(".")) + ".Data", /* @__PURE__ */ A(Ui, {
				fileData: JSON.stringify(r?.value.Data, null, 2),
				inputProps: i,
				subtype: i.defaultValue.Subtype
			}, t);
...
}, da = (e) => e.current.container, fa = (e, t) => {
	let n = e.current, r = n.labels[t], i = n.element_component[t];
	return n.useLabels[t] ? /* @__PURE__ */ j(T, {
		direction: "column",
		spacing: 1,
	...
	return { onChange: (n) => {
		...
		let s = a.split("."), c = s.slice(0, s.length - 1).join("."), l = s.slice(s.length - 1);
		$(Fi(da(e), c)) && (c = s.slice(0, s.length - 2).join(".")), n.target.type === "checkbox" && (r = n.currentTarget.checked), e.current = t, ua(e, zi(da(e), c, l, r)), e.current = t;
	} };
}, ha = (e, t) => {
	let n = e.current, r = n.nameIndex[t];
	return n.elements[r];
...
}, va = (e, t) => e.current.nameIndex[t], ya = (e, t) => {
	let n = e.current;
	delete n.labels[va(e, t)], e.current = n;
}, ba = ({ formRef: e, container: t }) => {
	Li(t, (t) => {
		let n = t.path, r = t.value;
		if (Array.isArray(r)) {
			let t = [];
		...
		Object.keys(r).forEach((t) => {
			$(r[t]) || (typeof r[t] == "object" && Object.keys(r[t]).forEach((i) => {
				let a = {};
				a[i] = r[t][i], _a(e, n + "." + t + "." + i, a);
			}), Ci(r[t]) && _a(e, n + "." + t, r[t]));
		});
	});
}, xa = ({ title: e, button_title: t, getButton: n, tabs: r, getSchema: i, handleSave: o, elementSelector: l, footerButtons: f, refKey: p, register_component: m = !1, context: h = null }) => {
	...
	let [S, C] = c(void 0), [w, E] = c(0), O = async () => {
		try {
			ua(_, Bi(null, [], ".", await i())), la(_, b), ba({
				formRef: _,
				container: da(_)
			}), C(pa(_)), y(!0);
		} catch (e) {
	...
	return f ||= [
		/* @__PURE__ */ A(d, {
			onClick: () => {
				...
				e[_.current.index] = "";
				let t = da(_);
				$(Fi(t, "root.fields")) && ua(_, Mi(t, "root.fields", {})), _a(_, "root.fields." + _.current.index, e), C(pa(_));
			},
			children: "Add Field"
		}),
		/* @__PURE__ */ A(d, {
		...
		children: [n ? n(O) : /* @__PURE__ */ A(d, {
			...
			body: /* @__PURE__ */ j(u, {
				...
				children: [
					...
					w === 1 && /* @__PURE__ */ A(u, {
						sx: { p: 3 },
						children: /* @__PURE__ */ A("pre", { children: JSON.stringify(da(_)?.value, null, 2) })
					})
				]
			}),
			show: v,
...
}, Sa = ({ title: e, show: t, onCancel: n, onConfirm: r }) => /* @__PURE__ */ A(Si, {
	title: e || "Are you sure?",
	show: t,
	footer: /* @__PURE__ */ j(T, {
		direction: "column",
...
}), Ca = ({ refreshGrid: e, api: t, ...n }) => /* @__PURE__ */ A(xa, {
	title: "Create",
	getSchema: t.schema,
	handleSave: (n) => {
		t.create(n).then(() => e());
	...
	...n
}), wa = ({ refreshGrid: e, api: t, id: n, title: r, footerButtons: i, ...a }) => /* @__PURE__ */ A(xa, {
	title: r,
	button_title: "Update",
	getSchema: ea(t, n),
	handleSave: (r) => {
	...
	refKey: String(n),
	...a
}), Ta = ({ refreshGrid: e, api: t, handleSelectedIds: n }) => {
	let [r, i] = c(!1);
	return /* @__PURE__ */ j(T, {
		direction: "horizontal",
		spacing: 2,
	...
	return /* @__PURE__ */ j(T, {
		...
		children: [/* @__PURE__ */ A(wa, { ...i }), /* @__PURE__ */ A(Ea, { ...i })]
	});
}, Oa = (e, t) => {
	let n = e.current;
	n && (n.endpoint = t);
}, ka = (e) => e.current.endpoint, Aa = (e) => e.current.api, ja = (e, t) => {
	...
	return n;
}, Ba = (e) => e.current.paginationModel, Va = (e, t) => {
	let n = e.current;
...
}, qa = (e) => e.current.fetch_params, Ja = (e, t) => ({ getRows: async (n) => {
	let r = e.current;
	if (!r) return {
		rows: [],
		rowCount: 0
	};
	Wa(e, n.filterModel), Ua(e, n.sortModel);
	let { page: i, pageSize: a } = n.paginationModel ?? {
		page: 0,
		pageSize: 10
	}, o = {
	...
	return Ma(e, l), Fa(e, l), r.row_count = c.pagination?.total || 0, e.current = r, t(), {
		rows: La(e),
		rowCount: c.pagination?.total || 0
	};
} }), Ya = (e, t) => {
	...
	let n = e.current;
	n && (n.datasource = t, e.current = n, await Qa(e));
}, Za = (e) => e.current?.datasource, Qa = async (e) => {
	let t = e.current;
	if (!t) return;
	let n = t.gridRef.current;
	n.dataSource.cache.clear(), await n.dataSource.fetchRows(), t.refresh();
	...
	return (n) => {
		...
		return /* @__PURE__ */ A(Da, {
			...
			handleRefreshGrid: async () => await Qa(e),
			api: r.api,
			id: n.id
		});
	};
}, ro = ({ api: e, endpoint: t, row_details: n, refKey: r, cellRenderer: i, register_component: o = !1, toolbar: l = !1, checkbox_select: u = !1, datagrid_sx: d = void 0, grid_options: f = void 0, context: p = void 0 }) => {
	...
	return h.current ||= {
		...
		onRowSelectionModelChange: (e) => $a(h)(e),
		paginationMode: "server",
		sortingMode: "server",
		filterMode: "server",
		autosizeOnMount: !0,
...
}, io = ({ loading: e, value: t }) => /* @__PURE__ */ A(u, {
	sx: {
		position: "relative",
		display: "inline-flex"
	},
...
}, so = (e) => !e || !e.current ? 1 : e.current.progressValue, co = (e, t) => {
	let n = e.current;
	n && n.handleToggle(t);
}, lo = ({ refKey: e, register_component: t, hidden: r, onDropSuccess: i, onSend: o, textFieldSx: l, textFieldProps: u, sendButtonProps: d }) => {
	let [f, p] = c(""), [m, h] = c(!1), [g, _] = c(0), v = _i(e, t), b = s({
		handleToggle: (e) => {
			h(e);
		},
		progressValue: 0,
	...
	let { ref: E, ...D } = S(), ee = m ? /* @__PURE__ */ A(io, {
		loading: !0,
		value: g
	}) : /* @__PURE__ */ A(ao, {
		onClick: o(b),
...
}), mo = ({ children: e, theme: t }) => {
	let n = po;
	return t || (n = po), /* @__PURE__ */ A(fo, { children: /* @__PURE__ */ j(te, {
		theme: n,
		children: [/* @__PURE__ */ A(m, {}), /* @__PURE__ */ A(uo, { children: /* @__PURE__ */ A(T, {
			direction: "column",
			sx: {
				width: "100%",
				justifyContent: "center",
	...
	return /* @__PURE__ */ j(T, {
		...
		children: [/* @__PURE__ */ A(d, {
			...
			children: /* @__PURE__ */ A(ie, { children: e.map((e) => ($(e.props.grid_options) && (e.props.grid_options = { onRowSelectionModelChange: i(e.props.refKey) }), /* @__PURE__ */ A(e.table, { ...e.props }))) })
		})]
	});
}, yo = (e) => {
	let [t, n] = c(""), r = Yn(), i = async (e) => {
		let i = { current: r?.get(t) }, a = e.target.value;
		ii(i, a), n(e.target.value), await oi(i);
	};
	return /* @__PURE__ */ A(T, {
		spacing: 3,
		sx: {
...
//#endregion
export { _a as AddElement, $i as Api, bi as ApiButton, pi as AppController, Ni as AppendChildren, Bi as BuildContainerTree, xi as CenteredContainer, Si as CenteredModal, ca as Close, vo as CompareTables, Ca as Create, ra as CsvDatagridSx, ia as CsvGrid, Ja as DataSourceWrapper, ho as DatagridSx, Ea as Delete, ya as DeleteLabel, Ta as DeleteMany, Da as EditCellRenderer, go as FieldValueGrid, Aa as GetApi, to as GetCellRenderer, ki as GetChildren, da as GetContainer, Za as GetDatasource, va as GetElementIndex, ga as GetElementTypes, ha as GetElementValue, pa as GetElements, ka as GetEndpoint, qa as GetFetchParams, za as GetHeaders, Ia as GetKeyValueRows, Ba as GetPaginationModel, Oi as GetParent, ji as GetPath, so as GetProgressValue, Ra as GetRawHeaders, La as GetRows, fa as GetSet, Ai as GetValue, na as GridWithButtons, mo as HFCenteredLayout, ea as HandleGet, uo as HeaderFooterLayout, sa as InitialTypeFormBuilderRefState, $ as IsNullOrUndefined, Ci as IsPrimitive, no as ModalCellRendererWrapper, Mi as NewObject, io as ProgressAdornment, Li as RangeContainers, Ri as RangePrimitiveValues, Ii as RangeValues, Fi as ReadFromContainers, Pi as ReadFromValue, mi as RefIndexContext, fo as RefProvider, Qa as Refresh, aa as SelectAssociation, ao as SendIconButton, ja as SetApi, Va as SetArgs, eo as SetCellRenderer, ua as SetContainer, Xa as SetDatasource, Oa as SetEndpoint, Ka as SetFetchParams, Wa as SetFilterModel, la as SetHandleClose, Ma as SetHeadersFromJson, Na as SetKeyValueHeaders, Pa as SetKeyValueRows, co as SetLoading, Ha as SetOrAddArgs, Ga as SetPaginationModel, oo as SetProgressValue, Fa as SetRowsFromJson, Ya as SetSearch, $a as SetSelectedRows, Ua as SetSortModel, _o as SetTableState, wi as TitleCase, ba as TypeFormBuilder, xa as TypeFormBuilderModal, vi as UIAppBar, yi as UIBottomNav, lo as UIInput, ro as UITable, wa as Update, zi as UpdateContainerByPath, ma as UpdateElementValues, yo as VectorSearch, Di as createContainer, _i as useConditionalRef, gi as useManagedRef, hi as useRefIndex };
